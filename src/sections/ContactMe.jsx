    ...
    <Container>
      <Row>
        ...
        <h1 className="primary display-3 fw-bold">
          ...
          <hr />
        <div className="mt-5 d-lg-flex justify-content-center align-items-center">
          <div className="col-lg-4 col-sm-12 pe-5">
            <p className=" fw-bold display-6 primary">
              Please fill the form if you want to reach me out!
            </p>
          ...
          <div className="col-lg-7 col-sm-12">
            ...
            <Form noValidate validated={validated} className='' ref={form} onSubmit={sendEmail}>
                ...
                className="mb-3"
              >
                <Form.Control name="user_name" type="text" placeholder="Your name" controlId="userName" required />
              ...
              <FloatingLabel
                ...
                className="mb-3"
              >
                <Form.Control name="user_email" type="email" placeholder="name@example.com" controlId="email" 
