        ...
        <Container>
            <Row>
                <div className="p-5">
                    ...
                    <hr />
                    <p className="mt-3 primary display-5">
                        Finished projects
                    </p>
                        <div className="projectSets d-lg-flex justify-content-center">
                    ...
                    <p className="mt-5 primary display-5">
                        In development
                    </p>
                    <div className="projectSets d-lg-flex ">
